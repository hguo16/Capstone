...
if ($submit) {
    ...
    $stmt = $db->prepare("SELECT * FROM magiccards WHERE magicName LIKE '%" . $search . "%'");
...
<html>
    ...
    <body class="body2">
        <div class="header">
            ...
            <div class="btn">
                <a href="deckEdit.php?id=<?php echo $id ?>">Back</a>
            </div>
        </div>

        <div class="search">
            <form method="GET" action="cardlist.php?id=<?php echo $id ?>">
        ...
        <table>
            ...
            <?php foreach ($results as $row): ?>
                <tr>
                    ...
                    <td><a href="addcard.php?card=<?php echo $row['magicId'] ?>">Add Card</a>
                </tr>
            <?php endforeach; ?>
            <script
